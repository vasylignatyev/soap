...
$soap=PhpWsdl::CreateInstance(
    ...
    $script,								// Change this to your SOAP endpoint URI (or keep it NULL and PhpWsdl will determine it)
    './cache',							// Change this to a folder with write access
    Array(								// All files with WSDL definitions in comments
        'Customer.php',
        'CustomerInfo.php'
    ),
    'Customer',				        	// The name of the class that serves the webservice will be determined by PhpWsdl
    null,								// This demo contains all method definitions in comments
    null,								// This demo contains all complex types in comments
    falce,								// Don't send WSDL right now
